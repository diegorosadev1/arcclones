                ...
                >
                  <div
                    className={clsx(
                      ...
                      isActive
                        ? 'bg-accent border-accent text-white scale-110 shadow-[0_0_15px_rgba(225,29,72,0.4)]'
                        : isCompleted
                  ...
                  <div className="space-y-8">
                    <div className="space-y-2">
                      ...
                      <p className="text-zinc-500">
                        Precisamos de alguns dados básicos para processar seu pedido.
                      </p>
                    </div>
                ...
                {currentStep === 'shipping' && (
                  <div className="space-y-8">
                    <div className="space-y-2">
                      ...
                      <p className="text-zinc-500">
                        Onde você deseja receber seus itens de luxo?
                      </p>
                    </div>
                        ...
                        <button
                          ...
                          className={clsx(
                            ...
                            formData.paymentMethod === method.id
                              ? 'bg-accent/5 border-accent shadow-[0_0_15px_rgba(225,29,72,0.1)]'
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3 max-h-64 overflow-y-auto pr-2">
                          {cart.map((item) => (
                            <div
                              key={item.id}
                              className="flex items-center gap-4 p-3 rounded-xl bg-zinc-900/30 border border-zinc-800"
                            >
                              <img
                                src={item.images[0]}
                                alt={item.name}
                              ...
                              <div className="flex-grow">
                                ...
                                <p className="text-xs text-zinc-500">
                                  {item.quantity}x R${' '}
                                  {(item.promoPrice || item.price).toLocaleString()}
                                </p>
                              </div>
