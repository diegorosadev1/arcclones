    ...
    <div className="space-y-24 pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 px-4 py-2 rounded-full">
              ...
              <span className="text-accent text-xs font-bold uppercase tracking-widest">Coleção Exclusiva 2026</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: 'Relógios', img: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80&w=800', path: '/catalog?category=Watches' },
            { name: 'Bolsas', img: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&q=80&w=800', path: '/catalog?category=Shoulder Bags' },
            { name: 'Óculos', img: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?auto=format&fit=crop&q=80&w=800', path: '/catalog?category=Glasses' },
            { name: 'Joias', img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&q=80&w=800', path: '/catalog?category=Jewelry' },
          ].map((cat, i) => (
            <motion.div
              key={cat.name}
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
          ...
          <Link to="/catalog" className="btn-outline">Ver Todos os Produtos</Link>
        </div>
      ...
      <section className="bg-luxury-card py-24 border-y border-zinc-800">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <ShieldCheck size={32} />, title: 'Autenticidade Garantida', desc: 'Todos os nossos produtos passam por um rigoroso processo de verificação de originalidade.' },
              { icon: <Zap size={32} />, title: 'Entrega Expressa', desc: 'Receba seus itens com rapidez e segurança em qualquer lugar do Brasil.' },
              { icon: <Headphones size={32} />, title: 'Suporte VIP 24/7', desc: 'Nossa equipe dedicada está sempre pronta para atender você com exclusividade.' },
              { icon: <RefreshCw size={32} />, title: 'Troca Facilitada', desc: 'Não serviu ou não gostou? Você tem até 30 dias para realizar a troca sem burocracia.' },
              { icon: <Star size={32} />, title: 'Curadoria Premium', desc: 'Apenas as marcas mais prestigiadas e os modelos mais exclusivos do mercado.' },
              { icon: <Quote size={32} />, title: 'Comunidade Exclusiva', desc: 'Faça parte do nosso clube de vantagens e receba convites para eventos privados.' },
            ].map((feature, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className="text-accent mb-6 transform transition-transform group-hover:scale-110 duration-300">{feature.icon}</div>
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-12">
          <div className="flex items-center justify-between">
            ...
            <Link to="/catalog" className="text-accent text-sm font-bold hover:underline">Ver Mais</Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { name: 'Ricardo Santos', role: 'Colecionador', text: 'A qualidade dos relógios é simplesmente impecável. O atendimento VIP fez toda a diferença na minha escolha.' },
            { name: 'Mariana Lima', role: 'Fashion Blogger', text: 'Minha bolsa favorita veio daqui. O acabamento é superior a qualquer outra loja que já comprei no Brasil.' },
            { name: 'Carlos Eduardo', role: 'Empresário', text: 'Entrega extremamente rápida e produto muito bem embalado. Transmite confiança desde o primeiro clique.' },
          ].map((t, i) => (
            <motion.div
              key={i}
